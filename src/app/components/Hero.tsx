  ...
  return (
    <section className="min-h-[90vh] bg-[url(/images/Hero2.jpg)] bg-cover bg-center flex flex-col items-center justify-center">
      <div className="mx-10 text-white flex flex-col items-center justify-center gap-5">
        <h2 className="text-center text-wrap text-5xl">Taking your car from <span className="italic text-8xl tracking-widest leading-15" id="grime"><br/>Grime</span> <br/>to <span className="italic text-6xl tracking-widest" id="shine"><br/>Shine</span></h2>
      </div>
